...
<p align="center"><img src="https://github.com/user-attachments/assets/2b0d5908-cf14-4f70-9600-dd9979acc324" width="300" alt="Multimini logo"></p>
...
python3 plot-density.py --plot_only_small_values  # loads every json files and save the plot to "density_4_w_{w}.pdf
```
